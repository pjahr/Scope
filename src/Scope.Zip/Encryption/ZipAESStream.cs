...
namespace Scope.Zip.Encryption
{
  /// <summary>
      ...
      while (nBytes < count)
      {
        ...
        else
        {
          ...
          if (byteCount > AUTH_CODE_LENGTH)
          {
            ...
            _transform.TransformBlock(_slideBuffer, _slideBufStartPos, finalBlock, buffer, offset);
          ...
          for (int i = 0; i < AUTH_CODE_LENGTH; i++)
          {
            ...
            {
              throw new
                Exception("AES Authentication Code does not match. This is a super-CRC check on the data in the file after compression and encryption. \r\n"
