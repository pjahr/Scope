  ...
  public class TarHeader
  {
    ...
    public DateTime ModTime
    {
      ...
      set
      {
        ...
        modTime = new DateTime(value.Year,
                               value.Month,
                               value.Day,
                               value.Hour,
                               value.Minute,
    ...
    /// </summary>
    public byte TypeFlag { get => typeFlag; set => typeFlag = value; }
    ...
    /// </summary>
    public int DevMajor { get => devMajor; set => devMajor = value; }

    /// <summary>
    /// Get/set the entry's minor device number.
    /// </summary>
    public int DevMinor { get => devMinor; set => devMinor = value; }
    ...
    public void ParseBuffer(byte[] header)
    {
      ...
      if (Magic == "ustar")
      {
        ...
        string prefix = ParseName(header, offset, PREFIXLEN)
         .ToString();
    ...
    internal static void SetValueDefaults(int userId,
                                          string userName,
                                          int groupId,
                                          string groupName)
    {
    ...
    public static int GetNameBytes(StringBuilder name,
                                   int nameOffset,
                                   byte[] buffer,
                                   int bufferOffset,
                                   int length)
    ...
    public static int GetAsciiBytes(string toAdd,
                                    int nameOffset,
                                    byte[] buffer,
                                    int bufferOffset,
                                    int length)
