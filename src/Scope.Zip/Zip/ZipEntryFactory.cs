...
namespace Scope.Zip.Zip
{
  ...
  public class ZipEntryFactory : IEntryFactory
  {
    ...
    /// </summary>
    public TimeSetting Setting { get => timeSetting_; set => timeSetting_ = value; }
    ...
    public int GetAttributes { get => getAttributes_; set => getAttributes_ = value; }

    /// <summary>
    /// A bitmask defining which attributes are to be set on.
    /// </summary>
    /// <remarks>By default no attributes are set on.</remarks>
    public int SetAttributes { get => setAttributes_; set => setAttributes_ = value; }

    /// <summary>
    /// Get set a value indicating wether unidoce text should be set on.
    /// </summary>
    public bool IsUnicodeText { get => isUnicodeText_; set => isUnicodeText_ = value; }
    ...
    {
      var result = new ZipEntry(nameTransform_.TransformFile(!string.IsNullOrEmpty(entryName)
                                                               ? entryName
                                                               : fileName));
