...
namespace Scope.Zip.Zip
{
  ...
  public class DescriptorData
  {
    ...
    /// </summary>
    public long CompressedSize { get => compressedSize; set => compressedSize = value; }
    ...
    /// </summary>
    public long Crc { get => crc; set => crc = value & 0xffffffff; }
  ...
  {
    public long SizePatchOffset { get => sizePatchOffset_; set => sizePatchOffset_ = value; }

    public long CrcPatchOffset { get => crcPatchOffset_; set => crcPatchOffset_ = value; }
  ...
  internal class ZipHelperStream : Stream
  {
    ...
    public bool IsStreamOwner { get => isOwner_; set => isOwner_ = value; }
    ...
    public long LocateBlockWithSignature(int signature,
                                         long endLocation,
    ...
    public void WriteZip64EndOfCentralDirectory(long noOfEntries,
                                                long sizeEntries,
    ...
    public void WriteEndOfCentralDirectory(long noOfEntries,
                                           long sizeEntries,
                                           ...
                                           byte[] comment)
    {
      ...
      int commentLength = comment != null
                            ? comment.Length
                            : 0;

      if (commentLength > 0xffff)
      {
        throw new ZipException(string.Format("Comment length({0}) is too long can only be 64K",
                                             commentLength));
      }
