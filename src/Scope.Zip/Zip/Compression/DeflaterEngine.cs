...
namespace Scope.Zip.Zip.Compression
{
  /// <summary>
  ...
  public class DeflaterEngine
  {
    ...
    /// </summary>		
    public DeflateStrategy Strategy { get => strategy; set => strategy = value; }
    ...
    private void SlideWindow()
    {
      ...
      {
        int m = head[i] & 0xffff;
        head[i] = (short) (m >= DeflaterConstants.WSIZE
                             ? m - DeflaterConstants.WSIZE
                             : 0);
      }
      ...
      {
        int m = prev[i] & 0xffff;
        prev[i] = (short) (m >= DeflaterConstants.WSIZE
                             ? m - DeflaterConstants.WSIZE
                             : 0);
      }
    }
