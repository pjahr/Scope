...
namespace Scope.Zip.Zip
{
  ...
  public class ZipEntry
  {
    ...
    /// </exception>
    public ZipEntry(string name) : this(name,
                                        0,
                                        ZipConstants.VersionMadeBy,
    ...
    /// The name passed is null
    /// </exception>
    internal ZipEntry(string name, int versionRequiredToExtract) : this(name,
    ...
    /// </summary>
    internal byte CryptoCheckValue { get => cryptoCheckValue_; set => cryptoCheckValue_ = value; }
    ...
    public long ZipFileIndex { get => zipFileIndex; set => zipFileIndex = value; }
    ...
    public bool IsDOSEntry =>
      HostSystem == (int) HostSystemID.Msdos || HostSystem == (int) HostSystemID.WindowsNT;
    ...
    public bool LocalHeaderRequiresZip64
    {
      get
      {
        ...
        if (!result)
        {
          ...
          result = (size >= uint.MaxValue || trueCompressedSize >= uint.MaxValue)
    ...
    public DateTime DateTime
    {
      get
      {
        ...
        int day = Math.Max(1,
                           Math.Min(DateTime.DaysInMonth((int) year, (int) mon),
                                    (int) ((dosTime >> 16) & 0x1f)));
    ...
    /// </returns>
    /// <see cref="Zip.CompressionMethod.ZStd"/>
    ...
    private void ProcessAESExtraData(ZipExtraData extraData)
    {
      if (extraData.Find(0x9901))
      {
        ...
        int actualCompress =
          extraData.ReadShort(); // The actual compression method used to compress the file
        _aesVer = ver;
    ...
    public bool IsDirectory
    {
      get
      {
        ...
        bool result =
          nameLength > 0 && (name[nameLength - 1] == '/' || name[nameLength - 1] == '\\')
          || HasDosAttributes(16);
        return result;
      }
    }
    ...
    {
      return method == CompressionMethod.ZStd
    ...
    public static string CleanName(string name)
    {
      ...
      if (Path.IsPathRooted(name))
      {
        ...
        name = name.Substring(Path.GetPathRoot(name)
                                  .Length);
      }
