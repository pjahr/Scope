...
namespace Scope.Zip.Lzw
{
  ...
  public class LzwInputStream : Stream
  {
    ...
    private void ParseHeader()
    {
      ...
      {
        throw new
          LzwException(string.Format("Wrong LZW header. Magic bytes don't match. 0x{0:x2} 0x{1:x2}",
                                     hdr[0],
                                     hdr[1]));
      }
      ...
      {
        throw new LzwException("Stream compressed with "
                               + maxBits
