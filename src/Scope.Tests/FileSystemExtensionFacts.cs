...
namespace Scope.Tests
{
    public class FileSystemExtensionFacts
    {
        ...
        public void GetFileName_retrieves_the_file_name_portion_of_a_path(string path, string expectedOutput)
        {
        ...
        [InlineData(".a", "a")]
        public void GetExtension_retrieves_the_file_extension_portion_of_a_path(string path, string expectedOutput)
        {
